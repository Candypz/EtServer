...
inline void InitDefaults() {
  ...
  InitDefaultsCRegistration_Req();
  InitDefaultsCRegistration_Res();
}
}  // namespace protobuf_GameMessage_2eproto
class CMessage;
...
class CMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CMessage) */ {
 ...
 private:
  ...
  friend void ::protobuf_GameMessage_2eproto::InitDefaultsCMessageImpl();
};
// -------------------------------------------------------------------
...
class CRegistration_Req : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CRegistration_Req) */ {
 public:
  ...
  #if LANG_CXX11
  CRegistration_Req(CRegistration_Req&& from) noexcept
    : CRegistration_Req() {
    *this = ::std::move(from);
  }

  inline CRegistration_Req& operator=(CRegistration_Req&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  friend void swap(CRegistration_Req& a, CRegistration_Req& b) {
    a.Swap(&b);
  }
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_GameMessage_2eproto::TableStruct;
  friend void ::protobuf_GameMessage_2eproto::InitDefaultsCRegistration_ReqImpl();
};
// -------------------------------------------------------------------
...
class CRegistration_Res : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CRegistration_Res) */ {
 public:
  ...
  #if LANG_CXX11
  CRegistration_Res(CRegistration_Res&& from) noexcept
    : CRegistration_Res() {
    *this = ::std::move(from);
  }

  inline CRegistration_Res& operator=(CRegistration_Res&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  friend void swap(CRegistration_Res& a, CRegistration_Res& b) {
    a.Swap(&b);
  }
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_GameMessage_2eproto::TableStruct;
  friend void ::protobuf_GameMessage_2eproto::InitDefaultsCRegistration_ResImpl();
};
// ===================================================================
